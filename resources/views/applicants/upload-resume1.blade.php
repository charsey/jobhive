        ...
        <div class="row justify-content-center pb-sm-2">
          <div class="col-lg-11 col-xl-10">
            ...
            <div class="text-center pb-4 mb-3">
              ...
              <button class="btn btn-primary btn-lg rounded-pill" type="button"><i class="fi-upload me-2"></i>Upload existing resume</button>
            </div>
            <!-- Steps-->
            ...
            <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 mb-4">
                  ...
                  <input class="form-control form-control-lg" type="phone" name="phone_no" id="pr-phone" placeholder="Enter your phone number" value=@if(isset($applicantInfo))
                  {{ $applicantInfo->phone_no}} 
                  @endif
                  > 
                </div>
                <div class="col-sm-6 mb-4">
                  ...
                  <div class="input-group input-group-lg">
                    <input name="d_o_b" class="form-control form-control-lg" type="date" id="pr-birth-date" placeholder="Choose date" value=@if(isset($applicantInfo))
                  {{ $applicantInfo->d_o_b}} 
                  @endif >                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 mb-4">
                  ...
                  <input class="form-control form-control-lg" name="country" type="text" id="country" placeholder="Country" value=@if(isset($applicantInfo))
                  {{ $applicantInfo->country}} 
                  @endif>
                </div>
                <div class="col-sm-6 mb-4">
                  <label class="form-label" for="pr-country">City<span class='text-danger'>*</span></label>
                  <input class="form-control form-control-lg" name="city" type="text" id="pr-birth-date" placeholder="Country" value=@if(isset($applicantInfo))
                  {{ $applicantInfo->city}} 
                  @endif>
                </div>
                <div class="col-12 mb-4">
                  <label class="form-label" for="pr-address">Your address</label>
                  <input class="form-control form-control-lg" name="address" type="text" id="pr-address" placeholder="Enter the address" value=@if(isset($applicantInfo))
                  {{ $applicantInfo->phone_no}} 
                  @endif>
                </div>
              </div>
            ...
            <!-- Navigation-->
            <div class="d-flex flex-column flex-sm-row bg-light rounded-3 p-4 px-md-5"><button class="btn btn-primary btn-lg rounded-pill ms-sm-auto">Next step<i class="fi-chevron-right fs-sm ms-2"></i></button></div>
