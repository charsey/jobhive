        ...
        <div class="row justify-content-center pb-sm-2">
          ...
          <form method="post" action="step2">
            ...
            <div class="bg-light rounded-3 p-4 p-md-5 mb-3">
              <h2 class="h4 mb-4"><i class="fi-education text-primary fs-4 mt-n1 me-2 pe-1"></i>Education</h2>
              <div class="row">
                <div class="col-sm-6 mb-4">
                  <label class="form-label" for="pr-education-level">Level of education <span class='text-danger'>*</span></label>
                  <select name="edu_level" class="form-select form-select-lg" id="pr-education-level" required>
                    <option value="" disabled>Choose your level of education</option>
                    <option value="Associate Degree" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="Associate Degree") selected @endif @endif>Associate Degree</option>
                    <option value="Bachelor's Degree" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="Bachelor's Degree") selected @endif @endif>Bachelor's Degree</option>
                    <option value="Graduate Degree" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="Graduate Degree") selected @endif @endif>Graduate Degree</option>
                    <option value="Professional Degree" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="Professional Degree") selected @endif @endif>Professional Degree</option>
                    <option value="Master Degree" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="Master Degree") selected @endif @endif>Master Degree</option>
                    <option value="PhD" @if(isset($applicantEdu)) @if($applicantEdu->edu_level =="PhD") selected @endif @endif>PhD</option>
                  </select>
                </div>
                <div class="col-sm-6 mb-4">
                  <label class="form-label" for="pr-study-field">Field of study <span class='text-danger'>*</span></label>
                  <input name="field_of_study" class="form-control form-control-lg"  type="text" id="pr-study-field" placeholder="Enter field of study" required value="@if(isset($applicantEdu)){{$applicantEdu->field_of_study}}@endif">
                </div>
                <div class="col-sm-6 mb-4">
                  <label class="form-label" for="pr-college">College / University <span class='text-danger'>*</span></label>
                  <input class="form-control form-control-lg" name="school" type="text" id="pr-college" placeholder="Enter your college name" required value="@if(isset($applicantEdu)){{$applicantEdu->school}}@endif">
                </div>
                <div class="col-sm-6 mb-4">
                  <label class="form-label" for="pr-country">school Address<span class='text-danger'>*</span></label>
                  <input name="school_address" class="form-control form-control-lg" type="text" id="pr-country" placeholder="Enter country, city of your college" required  value="@if(isset($applicantEdu)){{$applicantEdu->school_address}}@endif"> 
                </div>
                <div class="col-lg-6 mb-4">
                  <label class="form-label" for="pr-period-from">Study period from <span class='text-danger'>*</span></label>
                  <div class="row gx-2 gx-sm-3">
                    <div class="col-7 col-sm-8">
                      <select name="studied_from_month" class="form-select form-select-lg" id="pr-period-from" required>
                        <option value="" disabled >Month</option>
                        <option value="January" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month =="January") selected @endif @endif>January</option>
                        <option value="February" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="February") selected @endif @endif>February</option>
                        <option value="March" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="March") selected @endif @endif>March</option>
                        <option value="April" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="April") selected @endif @endif>April</option>
                        <option value="May" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="May") selected @endif @endif>May</option>
                        <option value="June" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="June") selected @endif @endif>June</option>
                        <option value="July" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="July") selected @endif @endif>July</option>
                        <option value="August" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="August") selected @endif @endif>August</option>
                        <option value="September"@if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="September") selected @endif @endif>September</option>
                        <option value="October" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="October") selected @endif @endif>October</option>
                        <option value="November" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="November") selected @endif @endif>November</option>
                        <option value="December" @if(isset($applicantEdu)) @if($applicantEdu->studied_from_month  =="December") selected @endif @endif>December</option>
                      </select>
                    </div>
                ...
                <div class="col-lg-6 mb-4">
                  ...
                  <div class="row gx-2 gx-sm-3">
                    <div class="col-7 col-sm-8">
                      <select name="studied_to_month" class="form-select form-select-lg" id="pr-period-to" required>
                      <option value="" disabled >Month</option>
                        <option value="January" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month =="January") selected @endif @endif>January</option>
                        <option value="February" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="February") selected @endif @endif>February</option>
                        <option value="March" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="March") selected @endif @endif>March</option>
                        <option value="April" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="April") selected @endif @endif>April</option>
                        <option value="May" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="May") selected @endif @endif>May</option>
                        <option value="June" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="June") selected @endif @endif>June</option>
                        <option value="July" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="July") selected @endif @endif>July</option>
                        <option value="August" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="August") selected @endif @endif>August</option>
                        <option value="September"@if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="September") selected @endif @endif>September</option>
                        <option value="October" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="October") selected @endif @endif>October</option>
                        <option value="November" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="November") selected @endif @endif>November</option>
                        <option value="December" @if(isset($applicantEdu)) @if($applicantEdu->studied_to_month  =="December") selected @endif @endif>December</option>
                      </select>
                    </div>
                    <div class="col-5 col-sm-4">
